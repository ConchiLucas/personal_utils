...
func seedDefaultDashboardItems(gdb *gorm.DB) {
	...
	items := []model.DashboardItem{
		...
		{Section: "website", Title: "题目后台", Content: "http://localhost:19091/math", SortOrder: 10, WorkspaceSlug: "kid-workbench"},
		{Section: "website", Title: "家长后台", Content: "http://localhost:19081/", SortOrder: 11, WorkspaceSlug: "kid-workbench"},
		{Section: "website", Title: "Agent Context Router 控制台", Content: "http://127.0.0.1:49175/", SortOrder: 12, WorkspaceSlug: "python_workforce"},
		{Section: "website", Title: "English Material 英语素材管理平台", Content: "http://127.0.0.1:19638/", SortOrder: 13, WorkspaceSlug: "python_workforce"},
		{Section: "website", Title: "统一收件箱监控大盘 (Watch Inbox)", Content: "http://127.0.0.1:18501/", SortOrder: 14, WorkspaceSlug: "python_workforce"},
		{Section: "website", Title: "英语单词背诵平台 (Rob Word)", Content: "http://localhost:6111/", SortOrder: 15, WorkspaceSlug: "rob_english_word"},
		{Section: "website", Title: "句子完形填空平台 (Cloze Web)", Content: "http://localhost:6014/", SortOrder: 16, WorkspaceSlug: "rob_english_word"},
		{Section: "website", Title: "english-word 运营后台", Content: "http://127.0.0.1:6016/", SortOrder: 17, WorkspaceSlug: "rob_english_word"},
