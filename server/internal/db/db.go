...
func seedDefaultDashboardItems(gdb *gorm.DB) {
	...
	items := []model.DashboardItem{
		// 1. 常用网站 (website)
		{Section: "website", Title: "识字学习孩子端 (Literacy App)", Content: "http://localhost:19152/", SortOrder: 1, WorkspaceSlug: "kid-workbench"},
		{Section: "website", Title: "拼音学习孩子端 (Pinyin App)", Content: "http://localhost:19112/", SortOrder: 2, WorkspaceSlug: "kid-workbench"},
		{Section: "website", Title: "趣味算数孩子端 (Math App)", Content: "http://localhost:19142/", SortOrder: 3, WorkspaceSlug: "kid-workbench"},
		{Section: "website", Title: "英语启蒙孩子端 (English App)", Content: "http://localhost:19132/", SortOrder: 4, WorkspaceSlug: "kid-workbench"},
		{Section: "website", Title: "科普探索孩子端 (Science App)", Content: "http://localhost:19122/", SortOrder: 5, WorkspaceSlug: "kid-workbench"},
		{Section: "website", Title: "古诗学习孩子端 (Poem App)", Content: "http://localhost:19162/", SortOrder: 6, WorkspaceSlug: "kid-workbench"},
		{Section: "website", Title: "逻辑思维孩子端 (Logic App)", Content: "http://localhost:19192/", SortOrder: 7, WorkspaceSlug: "kid-workbench"},
		{Section: "website", Title: "成语学习孩子端 (Chengyu App)", Content: "http://localhost:19182/", SortOrder: 8, WorkspaceSlug: "kid-workbench"},
		{Section: "website", Title: "英语短句孩子端 (Phrase App)", Content: "http://localhost:19172/", SortOrder: 9, WorkspaceSlug: "kid-workbench"},
		...
		{Section: "website", Title: "英语单词背诵平台 (Rob Word)", Content: "http://localhost:6111/", SortOrder: 17, WorkspaceSlug: "rob_english_word"},
		{Section: "website", Title: "句子完形填空平台 (Cloze Web)", Content: "http://localhost:6014/", SortOrder: 18, WorkspaceSlug: "rob_english_word"},
		{Section: "website", Title: "english-word 运营后台", Content: "http://127.0.0.1:6016/", SortOrder: 19, WorkspaceSlug: "rob_english_word"},
		{Section: "website", Title: "股票量化交易前端 (Stock Vue)", Content: "http://localhost:6021/", SortOrder: 20, WorkspaceSlug: "stock_workforce"},
		{Section: "website", Title: "股票调度大盘 (Stock Schedule Web)", Content: "http://localhost:6022/", SortOrder: 21, WorkspaceSlug: "stock_workforce"},
		{Section: "website", Title: "共享配置中心 (Config Center Web)", Content: "http://127.0.0.1:18527/", SortOrder: 22, WorkspaceSlug: "shared-config-center"},
		...
		{Section: "website", Title: "Sub2API 聚合网关管理后台", Content: "http://localhost:8090/admin/dashboard", Extra: "Sub2API 接口聚合与分发管理控制台", SortOrder: 27, WorkspaceSlug: ""},
		...
		{
			Section:   "account",
			Title:     "Grok2API Web 管理后台",
			Content:   "http://127.0.0.1:37821/",
			Extra:     `{"username":"admin","password":"Grok2Api@SecurePass#2026","host":"127.0.0.1:37821","url":"http://127.0.0.1:37821/"}`,
			SortOrder: 8,
		},
		{
			Section:   "account",
			Title:     "Sub2API 聚合网关管理后台",
		...
		// 5. 常用脚本执行 (script - 一键直接运行)
		{
			...
			Title:     "Agent Context Router 状态巡检",
			Content:   "zsh /Users/conchi/workforce/python_workforce/agent-context-router/scripts/status-native-stack.sh",
			Extra:     "一键检查 Agent Context Router 前后端、Runner 及 Docker Engine 健康在线状态",
			SortOrder: 1,
		},
		{
			Section:   "script",
			Title:     "Agent Context Router 一键启动",
			Content:   "zsh /Users/conchi/workforce/python_workforce/agent-context-router/scripts/start-native-stack.sh",
			Extra:     "一键拉起 Agent Context Router 原生服务栈 (Backend 49173, Frontend 49175) 及本地 Runner",
			SortOrder: 2,
		},
		{
			Section:   "script",
			Title:     "Agent Context Router 一键重启",
			Content:   "zsh /Users/conchi/workforce/python_workforce/agent-context-router/scripts/restart-native-stack.sh",
			Extra:     "平滑重启 Agent Context Router 原生服务栈与 Runner",
			SortOrder: 3,
		},
		{
			Section:   "script",
			Title:     "Agent Context Router 一键停止",
			Content:   "zsh /Users/conchi/workforce/python_workforce/agent-context-router/scripts/stop-native-stack.sh",
			Extra:     "安全停止 Agent Context Router 原生服务进程与 Host Runner",
			SortOrder: 4,
		},
		{
			Section:   "script",
